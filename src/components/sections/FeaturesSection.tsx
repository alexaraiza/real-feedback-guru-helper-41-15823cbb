...
const restaurantFeatures = [
  ...
  {
    icon: <Building2 className="h-8 w-8 text-[#9b87f5]" />,
    title: "Brand Building",
    description: "Build your restaurant's online presence and reputation"
  },
  {
    icon: <Bot className="h-8 w-8 text-[#9b87f5]" />,
...
export const FeaturesSection = () => {
  return (
    <>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {customerFeatures.map((feature, index) => (
              <div key={index} className="text-center p-6 rounded-xl bg-white shadow-lg hover:shadow-xl transition-shadow">
                <div className="mb-4 inline-block p-3 bg-[#9b87f5]/5 rounded-full">
                  {feature.icon}
                </div>
      ...
      <section className="py-20 bg-gradient-to-b from-white via-[#E5DEFF]/30 to-[#D6BCFA]/20">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-12">
