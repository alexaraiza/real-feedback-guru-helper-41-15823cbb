...
import { CreateDemoButton } from "../demo/CreateDemoButton";
import { PreviewSection } from "../demo/PreviewSection";
...
export const CreateReviewPageSection = ({ onShowAuth }: CreateReviewPageSectionProps) => {
  ...
  const handlePageCreated = (restaurantName: string) => {
  ...
  return (
    <div className="relative">
      <div className="md:sticky md:top-24 space-y-4 md:space-y-6 bg-white/80 backdrop-blur-sm p-6 md:p-8 rounded-xl shadow-lg border border-pink-100">
        ...
        <CreateDemoButton onPageCreated={handlePageCreated} />
